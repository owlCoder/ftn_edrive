    ...
    class Program
    {
        ...
        private static void Run(Socket socket)
        {
            ...
            if (resource != null)
            {
                ...
                else if (resource.StartsWith("brisanje?"))
                {
        ...
        public static string IspisPorudzbine(Porudzbina p)
        {
            ...
            ispis += "<table border='1'>" +
                "<tr>" +
                "<th colspan='5' style='text-align: center;'>Uspesno je obrisana porudzbina sa kodom: " + p.Kod + "</th>" +
                "</tr>" +
                "<tr>" +
                "<th colspan='5' style='text-align: center;'>Preostale porudzbine</th>" +
                "</tr>" +
                "<tr>" +
                "<th>Adresa</th>" +
                "<th>Telefon</th>" +
            ...
            foreach (Porudzbina pn in porudzbine)
            {
                ispis += "<tr>" +
                    "<td>" + pn.Adresa + "</td>" +
                    "<td>" + pn.Telefon + "</td>" +
                    "<td>" + pn.Proizvod.ToUpper() + "</td>" +
                    "<td>" + pn.NacinPlacanja.ToUpper() + "</td>" +
                    "</tr>";
            }
