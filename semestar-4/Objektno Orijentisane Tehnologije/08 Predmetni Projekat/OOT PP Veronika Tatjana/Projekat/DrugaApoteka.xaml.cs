...
namespace Projekat
{
    public partial class DrugaApoteka : Window
    {
        public DrugaApoteka()
        {
            InitializeComponent();
            ...
            DataContext = this;
            listaRadnika.ItemsSource = App.Druga_apoteka.Radnici;

            DataContext = this;
            listaLekova.ItemsSource = App.Druga_apoteka.Lekovi;
        }
        ...
        private void pretragaRadnika_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            foreach (Radnik radnik in App.Druga_apoteka.Radnici)
            {
        ...
        private void obrisiRadnika_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (listaRadnika.SelectedItem != null)
            {
                ...
                {
                    App.Druga_apoteka.Radnici.Remove(r);
        ...
        private void dodajUApotekuRadnika_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                App.Druga_apoteka.Radnici.Add(novi);
                ime.Clear();
                prezime.Clear();
                jmbg.Clear();
                datum.Clear();
        ...
        private void obrisiLek_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (listaLekova.SelectedItem != null)
            {
                ...
                if (daNe == MessageBoxResult.Yes)
                {
                    App.Druga_apoteka.Lekovi.Remove(l);
        ...
        private void dodajLekUApoteku_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                App.Druga_apoteka.Lekovi.Add(novi);
                naziv.Clear();
                datumProizvodnje.Clear();
                datumVazenja.Clear();
                kolicina.Clear();
        ...
        private void pretragaLekova_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            foreach (Lek lek in App.Druga_apoteka.Lekovi)
            {
