...
namespace Projekat
{
    public partial class PrvaApoteka : Window
    {
        public PrvaApoteka()
        {
            InitializeComponent();
            ...
            DataContext = this;
            listaRadnika.ItemsSource = App.Prva_apoteka.Radnici;

            DataContext = this;
            listaLekova.ItemsSource = App.Prva_apoteka.Lekovi;
        }
        ...
        private void pretragaRadnika_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            foreach(Radnik radnik in App.Prva_apoteka.Radnici)
            {
        ...
        private void obrisiRadnika_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (listaRadnika.SelectedItem != null)
            {
                ...
                {
                    App.Prva_apoteka.Radnici.Remove(r);
        ...
        private void dodajUApotekuRadnika_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                App.Prva_apoteka.Radnici.Add(novi);
                ime.Clear();
                prezime.Clear();
                jmbg.Clear();
                datum.Clear();
        ...
        private void obrisiLek_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (listaLekova.SelectedItem != null)
            {
                ...
                if (daNe == MessageBoxResult.Yes)
                {
                    App.Prva_apoteka.Lekovi.Remove(l);
        ...
        private void dodajLekUApoteku_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                App.Prva_apoteka.Lekovi.Add(novi);
                naziv.Clear();
                datumProizvodnje.Clear();
                datumVazenja.Clear();
                kolicina.Clear();
        ...
        private void pretragaLekova_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            foreach (Lek lek in App.Prva_apoteka.Lekovi)
            {
