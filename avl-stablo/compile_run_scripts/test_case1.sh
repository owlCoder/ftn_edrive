...
then
  ...
  printf "~"
  tput sgr0;
  printf "$ ./balansirano_binarno_stablo 5 10 -6 12 4 2 14 65 565 154 6564\n"
  tput bold;
  tput setaf 2;
  printf "user"
  printf "@"
  ...
  mkdir complied;
  clear
gcc -o complied/balansirano_binarno_stablo_c1 binarno_stablo.c modules/binary_tree/binary_tree.h modules/binary_tree/binary_tree.c modules/avl_tree/avl_tree.h modules/avl_tree/avl_tree.c modules/main_thread/main_thread.h modules/main_thread/main_thread.c && ./complied/balansirano_binarno_stablo_c1 5 10 -6 5 12 4 6 656 2
  printf "\n\n"
else
    tput bold;
