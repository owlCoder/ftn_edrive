...
switch_statement
  : _SWITCH _LPAREN _ID
    {
      switch_id = lookup_symbol($3, VAR);

      if(switch_id == NO_INDEX)
        err("switch: '%s' undeclared", $3);
