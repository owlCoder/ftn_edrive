...
-- Design Ports Information
-- oY	=>  Location: PIN_N2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iB0	=>  Location: PIN_L2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iB2	=>  Location: PIN_L1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- iB1	=>  Location: PIN_J2,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF minimizacija IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \oY~0_combout\ = (\iB0~input_o\ & ((\iB2~input_o\) # (\iB1~input_o\))) # (!\iB0~input_o\ & ((!\iB1~input_o\)))
