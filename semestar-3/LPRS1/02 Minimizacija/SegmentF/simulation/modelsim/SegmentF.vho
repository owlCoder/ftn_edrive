...
ARCHITECTURE structure OF segmentF IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \oY~0_combout\ = (\iB0~input_o\ & (\iB3~input_o\ $ (((\iB2~input_o\ & !\iB1~input_o\))))) # (!\iB0~input_o\ & ((\iB2~input_o\) # ((\iB3~input_o\) # (!\iB1~input_o\))))
